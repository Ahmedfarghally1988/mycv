const SKILLS = [
  { name: "Photoshop", icon: "/mycv/img/icons/icon-photoshop.svg" },
  { name: "Figma", icon: "/mycv/img/icons/icon-figma.svg" },
  { name: "Illustrator", icon: "/mycv/img/icons/icon-illustrator.svg" },
  { name: "XD", icon: "/mycv/img/icons/icon-scketch.svg" },
  { name: "Bootstrap", icon: "/mycv/img/icons/icon-blender.svg" },
  { name: "Tailwindcss", icon: "/mycv/img/icons/icon-notion.svg" },
  { name: "Materializecss", icon: "/mycv/img/icons/materializecss-svgrepo-com.svg" },
  { name: "Sass", icon: "/mycv/img/icons/sass-svgrepo-com.svg" },
  { name: "HTML5", icon: "/mycv/img/icons/icon-html.svg" },
  { name: "CSS3", icon: "/mycv/img/icons/icon-css.svg" },
  { name: "Javascript", icon: "/mycv/img/icons/javascript-svgrepo-com.svg" },
  { name: "Jquery", icon: "/mycv/img/icons/jquery-svgrepo-com.svg" },
  {
    name: "Vuejs",
    icon: "/mycv/img/icons/vue-vuejs-javascript-js-framework-svgrepo-com.svg",
  },
  { name: "React", icon: "/mycv/img/icons/react-svgrepo-com.svg" },
];
